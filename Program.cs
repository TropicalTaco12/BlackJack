...
class Program
{
    ...
    {
        Random r = new Random();
        int playerCard = r.Next(1, 13);
        int playerCard2 = r.Next(1, 13);
        int dealerCard = r.Next(1, 13);
        int dealerCard2 = r.Next(1, 13);
        int playerTotal;
        int dealersTotal;
        int totalChips = 100;
        ...
        string y = NumberToCard(playerCard);
        ...
        while (true)
        {
            ...
            if (personInput1 == "hit")
            {
                Console.WriteLine("Your number is " + NumberToCard(playerNewCard));
